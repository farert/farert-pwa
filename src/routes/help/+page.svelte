	...
	const basicUsageFlowCharts = [
		{
			...
			nodes: [
				...
				{ id: 'main', x: 230, y: 125, label: ['メイン画面'], kind: 'junction' },
			...
			note: '分岐駅を選ぶとメイン画面へ戻り、必要な区間を順に指定します。目的地がその路線内にあるときは着駅選択へ進みます。'
		},
		{
			title: '最短経路指定',
			viewBox: '0 0 980 150',
			nodes: [
				...
				{ id: 'line', x: 240, y: 48, label: ['路線選択'] },
				{ id: 'shortest', x: 390, y: 48, label: ['最短経路'] },
				{ id: 'arrive', x: 540, y: 48, label: ['着駅選択'] },
				{ id: 'route', x: 690, y: 48, label: ['使用路線選択'] },
			...
			edgeLabels: [{ x: 200, y: 54, text: '経路追加' }],
