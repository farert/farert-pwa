...
- **<メイン>** → **<路線選択>**: メイン画面全体を左へスライドアウトし、路線選択画面を右からスライドインする。
- **<路線選択>** → **<メイン>**: 路線選択画面全体を右へスライドアウトし、メイン画面を左からスライドインする。
- **<路線選択>** → **<駅選択>**: 路線選択画面全体を左へスライドアウトし、駅選択画面を右からスライドインする。
- **<駅選択>** → **<路線選択>**: 駅選択画面全体を右へスライドアウトし、路線選択画面を左からスライドインする。
- 上記以外の遷移にはこのスライドアニメーションを適用しない。
